...
RUN set -eux; \
	...
	cp ${BUILD_DIR}/src/version/libversion.a ${WORK_DIR}/output/x86_64/lib/ 2>/dev/null || true; \
	...
	cp ${BUILD_DIR}/external/randomx/librandomx.a ${WORK_DIR}/output/x86_64/lib/ 2>/dev/null || true; \
	cp ${BUILD_DIR}/src/rpc/librpc_base.a ${WORK_DIR}/output/x86_64/lib/ 2>/dev/null || true; \
	cp ${BUILD_DIR}/src/wallet/libwallet-crypto.a ${WORK_DIR}/output/x86_64/lib/ 2>/dev/null || true; \
